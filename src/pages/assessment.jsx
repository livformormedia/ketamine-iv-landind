...
export default function Assessment() {
  ...
  // Fire custom event when assessment page opens
  useEffect(() => {
  ...
  const submitDisqualified = async (reason) => {
    ...
    try {
      console.log("Step 1: Creating disqualified assessment response...");
      const response = await AssessmentResponse.create({
        ...formData,
        status: "disqualified",
        disqualification_reason: reason
      });
      console.log("Step 1 SUCCESS: Assessment response created", response.id);
      
      console.log("Step 2: Sending to Make.com webhook...");
      ...
      console.log("Step 2 SUCCESS: Sent to Make.com");
    } catch (error) {
      console.error("ERROR in submitDisqualified:", error);
      alert(`Error submitting disqualification: ${error.message}`);
    }
  ...
  const submitQualified = async () => {
    setIsSubmitting(true);
    try {
      console.log("Step 1: Creating qualified assessment response...");
      const response = await AssessmentResponse.create({
        ...formData,
        status: "qualified"
      });
      ...
      console.log("Step 3: Redirecting to Thank You page...");
      ...
      console.log("Step 3 SUCCESS: Navigating to Thank You page");
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl">
          ...
          {step === 1 && (
            <div>
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Do you live in Georgia?</h2>
          ...
          {step === 6 && (
            <div>
              <h2 className="text-3xl font-bold text-slate-900 mb-3">How Can We Contact You?</h2>
