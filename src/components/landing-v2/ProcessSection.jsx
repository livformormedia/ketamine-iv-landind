    ...
    <section className="py-20 md:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div key={index} className="relative mb-8 last:mb-0">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1 bg-slate-50 rounded-2xl p-6 border-2 border-slate-200 hover:border-[#352253]/30 transition-colors">
                  <h3 className="text-xl font-bold text-[#352253] mb-2">{step.title}</h3>
                  <p className="text-[#352253]/70">{step.description}</p>
                </div>
              </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h3 className="text-3xl font-bold text-[#352253] mb-6">
            ...
            <ul className="space-y-4 mb-8">
              {treatmentConfig.PROCESS_CTA_BENEFITS.map((benefit, index) => (
                <li key={index} className="flex items-start gap-3">
                  ...
                  <span className="text-lg text-[#352253]/80">{benefit}</span>
                </li>
              ))}
            </ul>
            <Button 
